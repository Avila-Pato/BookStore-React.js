    ...
    <div className='mt-12 bg-primary rounded-lg'>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 rounded-xl'>
        <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
          ...
          <div>
            <h4 className='h4 capitalize'>Facil retorno</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis consequatur eaque, aliquid aliquam voluptatem quidem.</p>
          </div>
        </div>
        <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
          <div className='text-3xl'><TbTruckDelivery className='mb-3 text-red-500'/></div>
          <div>
            <h4 className='h4 capitalize'>Envio gratis</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis consequatur eaque, aliquid aliquam voluptatem quidem.</p>
          </div>
        </div>
         ...
         <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
          ...
          <div>
            <h4 className='h4 capitalize'>Pago Seguro</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis consequatur eaque, aliquid aliquam voluptatem quidem.</p>
          </div>
        </div>
